...
TEMPLATES = {
    ...
    ("P0", "belt_damage"): "P0 ALERT. Conveyor belt damage detected in {zone} near {machine}. Keep clear.",
    ("P1", "oil_leak"): "P1 alert. Fluid leak detected in {zone}. Supervisor notified.",
    ("P1", "belt_damage"): "P1 alert. Conveyor belt damage detected in {zone}. Maintenance required.",
}
